object frmRelFisicoFinanceiro: TfrmRelFisicoFinanceiro
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Relat'#243'rio F'#237'sico e Financeiro'
  ClientHeight = 216
  ClientWidth = 664
  Color = clBtnFace
  ...
  object chkAgrupamento: TCheckBox
    Left = 371
    Top = 18
    Width = 169
    Height = 17
  ...
  object dblAgrupamento: TDBLookupComboBox
    Left = 371
    Top = 41
    Width = 281
    Height = 21
  ...
  object rdAgrupamento: TRadioGroup
    Left = 192
    Top = 16
    Width = 173
    Height = 121
  ...
  object qryRelFisicoFinanceiro: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT '#39'Janeiro'#39' as '#39'dataInicio'#39', '#39'Dezembro'#39' as '#39'dataFinal'#39',  en' +
        't.logo, ent.nome as prefeitura, ent.nomeuf as estado, ent.cnpj, ' +
        'ent.resp1_nome, ent.resp1_cic, ent.resp1_cargo, '
      
        'ent.resp2_nome, ent.resp2_cic, ent.resp2_cargo, ent.resp3_nome, ' +
        'ent.resp3_cic, ent.resp3_cargo, '
      
        '       a.almoxarifadoid as CodigoLocalArmazen, a.descricao as Lo' +
        'calArmazenamento, '
      '       p.produtoID, p.descricao as NomeProduto,        '
      ...
      'join entidade as ent'
        ...
        'GROUP BY a.almoxarifadoid, a.descricao, ie.idproduto, p.descrica' +
        'o'
  ...
  object frxRelFisicoFinanceiro: TfrxReport
    ...
    ReportOptions.LastChange = 42740.602515590280000000
    ...
    object Page1: TfrxReportPage
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 1046.929810000000000000
        Condition = 'frxDBDataset1."LocalArmazenamento"'
        StartNewPage = True
      ...
      object MasterData2: TfrxMasterData
        ...
        DataSetName = 'frxDescontos'
        RowCount = 0
        object frxDescontosvaloracrescimodesconto1: TfrxMemoView
          Left = 3.779530000000000000
          Width = 79.370130000000000000
          Visible = False
          DataField = 'valoracrescimodesconto'
          DataSet = frxDescontos
          DataSetName = 'frxDescontos'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDescontos."valoracrescimodesconto"]')
          ParentFont = False
        end
      end
      object Footer1: TfrxFooter
        ...
        object frxDescontosvaloracrescimodesconto: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'R$ [SUM(<frxDBDataset1."EntradaFinanceiro">,MasterData1) - SUM(<' +
              'frxDescontos."valoracrescimodesconto">, MasterData2)]')
          ParentFont = False
        end
        object Memo20: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'R$ [SUM(<frxDBDataset1."SaidaFinanceiro">,MasterData1) - SUM(<fr' +
              'xDescontos."valoracrescimodesconto">, MasterData2)]')
          ParentFont = False
        end
        ...
        object frxDBDataset1resp1_nome: TfrxMemoView
        ...
        object frxDBDataset1resp2_nome: TfrxMemoView
  ...
  object ClientDataSet1: TClientDataSet
    ...
    object ClientDataSet1resp1_nome: TStringField
      FieldKind = fkCalculated
      FieldName = 'resp1_nome'
      Size = 50
      Calculated = True
    end
    object ClientDataSet1resp1_cic: TStringField
      FieldKind = fkCalculated
      FieldName = 'resp1_cic'
      Calculated = True
    end
    object ClientDataSet1resp1_cargo: TStringField
      FieldKind = fkCalculated
      FieldName = 'resp1_cargo'
      Size = 50
      Calculated = True
    end
    object ClientDataSet1resp2_nome: TStringField
      FieldKind = fkCalculated
      FieldName = 'resp2_nome'
      Size = 50
      Calculated = True
    end
    object ClientDataSet1resp2_cic: TStringField
      FieldKind = fkCalculated
      FieldName = 'resp2_cic'
      Calculated = True
    end
    object ClientDataSet1resp2_cargo: TStringField
      FieldKind = fkCalculated
      FieldName = 'resp2_cargo'
      Size = 50
      Calculated = True
    end
    object ClientDataSet1resp3_nome: TStringField
      FieldKind = fkCalculated
      FieldName = 'resp3_nome'
      Size = 50
      Calculated = True
    end
    object ClientDataSet1resp3_cic: TStringField
      FieldKind = fkCalculated
      FieldName = 'resp3_cic'
      Calculated = True
    end
    object ClientDataSet1resp3_cargo: TStringField
      FieldKind = fkCalculated
  ...
  object frxResponsaveis: TfrxDBDataset
    UserName = 'frxResponsaveis'
    CloseDataSource = False
    FieldAliases.Strings = (
      'nome=nome'
      'funcao=funcao'
  ...
  object qryResponsaveis: TADOQuery
    Active = True
    Connection = dmComprasEstoque.conexao
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'select distinct p.nome, p.funcao, p.cpf from almoxarifado a'
      'join pessoas p'
      
        'on a.idresponsavelautorizacao = p.pessoasID or a.idresponsavelde' +
        'spacho = p.pessoasID'
      ''
      '')
    Left = 88
